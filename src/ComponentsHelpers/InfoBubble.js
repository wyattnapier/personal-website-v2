  ...
  return (
    <div className="infobubble-wrapper">
      <div className="infobubble-content">
        ...
        <p>I would like to thank <a href="https://www.linkedin.com/in/morgan-myers-18368724a/">Morgan Myers</a> for advising the styling of this website. 
        I also want to credit <a href="https://icons8.com/">Icons8</a> and <a href="https://favicon.io/">Favicon</a> for the icons.</p>
        <button onClick={hideInfo} ><img className="ilogo-cancel" src={cancellogo} alt="Close popup"/></button>
      </div>
    </div>
  )
}
